...
class I2CDiagnostics:
    ...
    def setup(self):
        ...
        self.i2c = machine.SoftI2C(
            scl=Pin(self.scl), sda=Pin(self.sda), freq=self.freq)
        return self.i2c
    ...
    def scan(self, show=True):
        ...
        if show:
            print("  Bus        : I2C{} SDA=GPIO{} SCL=GPIO{} @ {} Hz".format(
...
def main(b=None):
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("  pins set: SDA=GPIO{} SCL=GPIO{} @ {} Hz".format(
                b.sda, b.scl, b.freq))
        elif choice == "0":
            return b
        else:
